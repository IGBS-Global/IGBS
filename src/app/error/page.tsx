...
export const metadata: Metadata = {
  title: "Error Page | Infinity Global Business Solutions Website",
  description: "This is Error Page for Startup Nextjs Infinity Global Business Solutions Website",
  // other metadata
};

...
export const metadata: Metadata = {
  title: "Blog Details Page | Infinity Global Business Solutions Blog Page",
  description: "This is Blog Details Page for Infinity Global Business Solutions Website",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  The Rise of EWA Platforms: A Game Changer for Startups
                </h1>
                ...
                {/* Add RelatedPost, SharePost, TagButton, and NewsLatterBox components here if needed */}
              </div>
            </div>
          </div>
        </div>
